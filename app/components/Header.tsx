  ...
  return (
    <header className="w-full z-50">
      <div className="max-w-full px-8 py-8 flex justify-between place-items-baseline  xl:mx-20">
        ...
        <Link href="/" className="text-3xl  md:text-5xl font-serif text-graphite tracking-wide 2xl:hidden ">
          Aelora
        </Link>

        {/* Навигация — можно оставить один элемент или скрыть */}
        <nav className="hidden md:flex  2xl:justify-start space-x-10 text-xl lg:text-3xl text-graphite font-semibold">
