  ...
  return (
    <header className="w-full z-50">
      <div className="max-w-6xl mx-auto px-6 py-8 flex justify-between items-center">
        ...
        <Link href="/" className="text-3xl md:text-4xl font-serif text-graphite tracking-wide font-semibold">
          Aelora
        </Link>

        {/* Навигация — можно оставить один элемент или скрыть */}
        <nav className="hidden md:flex items-center space-x-10 text-lg text-gray-700 uppercase tracking-wide font-semibold">
